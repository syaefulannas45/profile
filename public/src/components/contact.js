...
const Contact = () => {
  return `
     ...
     <img src="public/images/contact/elips.svg" class="absolute lg:top-[-380px] lg:left-10 hover:animate-pulse top-[-380px] left-[128px]" />
     <img src="public/images/contact/vector-1.svg" class="absolute lg:top-[-280px] lg:right-8 hover:animate-pulse" />
     <img src="public/images/contact/vector-2.svg" class="absolute lg:top-[-210px] lg:left-0 top-[400px] left-0 hover:animate-pulse mobile:h-[300px]" />
          <div
            ...
            <div class="lg:w-2/4">
              ...
              <div class="flex-col space-y-[25px] text-[15px] mt-[35px] dark:text-slate-100">
                <div class="flex items-center">
                 <div class="bg-gradient-to-t from-blues-100 to-blues-200 w-[30px] h-[30px] text-slate-800 dark:text-white rounded-full flex justify-center items-center"><i class="fa-solid fa-location-dot text-[20px] px-4 py-4"></i></div>
                 <span> &nbsp; Majasem, Kota Cirebon</span>
                </div>
                <div class="flex items-center">
                 <div class="bg-gradient-to-t from-blues-100 to-blues-200 w-[30px] h-[30px] text-slate-800 dark:text-white rounded-full flex justify-center items-center px-4 py-4">
                 <i class="fa-solid fa-phone text-[20px]"></i>
                </div>
                 <span> &nbsp; +62 123 4567 8910</span>
                </div>
               
                <div class="cursor-pointer flex space-x-[20px] text-[20px] text-slate-800 dark:text-slate-100">
