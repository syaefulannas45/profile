  ...
  <div class="relative pt-[100px] lg:pt-[100px] dark:bg-background-100 px-4 lg:px-[120px] w-full overflow-hidden pb-[340px] lg:pb-10">
        ...
        <div class="w-full lg:flex pt-6 lg:pt-0 lg:mt-[80px] lg:items-center">
          <div data-aos="fade-right" class="lg:w-2/4 w-full">
            ...
            <img loading="lazy" src="public/images/about/elips-1.svg" class="absolute lg:right-10 lg:bottom-0 bottom-[350px] right-[50px]" />
            <img loading="lazy" src="public/images/about/elips-2.svg" class="absolute lg:right-[-15px] lg:bottom-10 bottom-[380px] right-0" />
            <img loading="lazy" src="public/images/about/elips-3.svg" class="lg:hidden absolute left-[-20px] top-[400px]" />
          </div>
