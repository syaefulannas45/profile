  ...
  return `
     <div class="lg:flex lg:px-[120px] py-[25px] dark:bg-background-300  w-full lg:space-x-10 bg-background-400  px-4 space-y-4 lg:space-y-0">
        <div class="lg:w-[25%]">
          ...
          <p class="text-[13px] lg:text-[18px] text-slate-700 dark:text-slate-100">Seinjak sejejak setujuan</p>
        </div>
        <div class="lg:w-[25%]">
          ...
          <ul class="flex-col space-y-2  pt-2 text-[12px] lg:text-[15px]">
        ...
        <div class="lg:w-[25%]">
          ...
          <ul class="flex-col space-y-2 pt-2 text-[12px] lg:text-[15px]">
            ...
            <li class="text-slate-800 cursor-pointer dark:text-slate-100" ><a href="https://www.instagram.com/adcom_official/">Instagram</a></li>
            <li class="text-slate-800 cursor-pointer dark:text-slate-100"><a href="https://github.com/adcomofficial/">Github</a></li>
            <li class="text-slate-800 cursor-pointer dark:text-slate-100"><a href="https://youtube.com/@adcomchannel_">Youtube</a></li>
          </ul>
        </div>
        
      </div>
      <div class="dark:bg-background-300 w-full px-4  bg-background-400 text-[11px] lg:text-[14px]">
