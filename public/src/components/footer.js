...
const Footer = () => {
  return `
     <div class="lg:flex lg:px-[120px] py-[35px] dark:bg-background-300 dark:text-slate-100 w-full space-x-10 bg-background-400 mt-[250px] lg:mt-0 px-4 space-y-4 lg:space-x-0">
        <div class="lg:w-[25%]">
