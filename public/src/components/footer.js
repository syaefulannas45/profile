...
const Footer = () => {
  return `
     <div class="flex px-[120px] py-[35px] items-center dark:bg-background-300 dark:text-slate-100 w-full space-x-10">
          ...
          <div class="w-[25%]">
          <h1 class="bg-gradient-to-t from-blues-300 to-blues-400 bg-clip-text text-transparent text-[30px] border-b-2 font-semibold">Project</h1>
          <ul class="flex-col space-y-2  cursor-pointer pt-2">
          ...
          <div class="w-[25%]">
          <h1 class="bg-gradient-to-t from-blues-300 to-blues-400 bg-clip-text text-transparent text-[30px] border-b-2 font-semibold">Contact</h1>
