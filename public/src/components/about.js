...
const About = () => {
  return `
  <div class="pt-[10%] lg:pt-[100px] dark:bg-background-100 px-4 lg:px-[120px] w-full overflow-hidden pb-[340px] lg:pb-10">
        <div class="relative">
        <img loading="lazy" src="public/images/about/vector-1.svg" alt="vector" class="absolute lg:top-[0%] lg:left-[-9%] top-[9%] left-[-4%] z-40 mobile:h-[100px]" />
