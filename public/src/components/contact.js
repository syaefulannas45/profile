...
const Contact = () => {
  return `
     ...
     <img loading="lazy" src="public/images/contact/vector-2.svg" class="absolute lg:top-[-220px] lg:left-0 top-[410px] left-0 hover:animate-pulse mobile:h-[300px]" />
          <div
            class="w-full lg:flex lg:justify-between bg-white py-[50px] px-4 lg:px-[100px] border relative bottom-[320px] shadow-lg rounded-[8px] dark:bg-background-200 dark:border-0">
            <div class="lg:w-2/4">
